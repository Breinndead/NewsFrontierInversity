...
namespace ModernisedJournalism
{
    public partial class Form1 : Form
    {
        ...
        private void setPositions()
        {
            ...
            BBCGuess.BackColor = Color.White;
            GuardianGuess.BackColor = Color.White;
            IndependentGuess.BackColor = Color.White;
            MailGuess.BackColor = Color.White;
            SkyGuess.BackColor = Color.White;
            SunGuess.BackColor = Color.White;
            BBCGuess.Text = "Enter Guess";
            GuardianGuess.Text = "Enter Guess";
            IndependentGuess.Text = "Enter Guess";
            MailGuess.Text = "Enter Guess";
            SkyGuess.Text = "Enter Guess";
            SunGuess.Text = "Enter Guess";
        ...
        private async void getNews()
        {
            ...
            "/html/body/div[2]/div[3]/div[4]/div[1]/div[2]/div/div[1]/h2/a",
            "/html/body/div[2]/div[3]/div[4]/div[1]/div[3]/div/div[1]/div[3]/h2/a/text()",
            "/html/body/div[2]/div[3]/div[4]/div[1]/div[3]/div/div[2]/div[1]/div[3]/h2/a",
            "/html/body/div[2]/div[3]/div[4]/div[1]/div[3]/div/div[2]/div[2]/div/div[2]/h2/a",
            "/html/body/div[2]/div[3]/div[4]/div[1]/div[3]/div/div[2]/div[3]/div/div[2]/h2/a",
            "/html/body/div[2]/div[3]/div[4]/div[1]/div[5]/div/div[1]/div[3]/h2/a",
            "/html/body/div[2]/div[3]/div[4]/div[1]/div[5]/div/div[2]/div[1]/div[3]/h2/a",
            "/html/body/div[2]/div[3]/div[4]/div[1]/div[5]/div/div[2]/div[2]/div/div[2]/h2/a",
            "/html/body/div[2]/div[3]/div[4]/div[1]/div[5]/div/div[2]/div[3]/div/div[2]/h2/a",
            "/html/body/div[2]/div[3]/div[4]/div[1]/div[7]/div/div[1]/div[3]/h2/a" };

            string[] MailPaths = new string[10] {
            "/html/body/div[2]/div[2]/div[4]/div[2]/div[1]/div/div[1]/div/p/text()",
            "/html/body/div[2]/div[2]/div[4]/div[2]/div[2]/div[1]/div[1]/div[1]/div/h2/a",
            "/html/body/div[2]/div[2]/div[4]/div[2]/div[2]/div[1]/div[1]/div[2]/div[1]/h2/a/text()",
            "/html/body/div[2]/div[2]/div[4]/div[2]/div[2]/div[1]/div[1]/div[2]/div[2]/h2/a/text()",
            "/html/body/div[2]/div[2]/div[4]/div[2]/div[2]/div[1]/div[1]/div[2]/div[3]/h2/a/text()",
            "/html/body/div[2]/div[2]/div[4]/div[2]/div[2]/div[1]/div[1]/div[2]/div[4]/h2/a/text()",
            "/html/body/div[2]/div[2]/div[4]/div[2]/div[2]/div[1]/div[1]/div[2]/div[5]/h2/a/text()",
            "/html/body/div[2]/div[2]/div[4]/div[2]/div[2]/div[1]/div[2]/h2/a/text()",
            "/html/body/div[2]/div[2]/div[4]/div[2]/div[3]/div[1]/div/h2/a/text()",
            "/html/body/div[2]/div[2]/div[4]/div[2]/div[4]/div[1]/div/h2/a/text()" };
            ...
            "/html/body/div[6]/main/div/div[1]/div/div/div/a/span/div/div/h3",
            ...
            "/html/body/div[6]/main/div/div[2]/div/div[4]/div/div[2]/a/h3",
            "/html/body/div[6]/main/div/div[2]/div/div[5]/div/div[2]/a/h3",
            "/html/body/div[6]/main/div/div[4]/div/div[1]/div/div[2]/a/h3",
            "/html/body/div[6]/main/div/div[4]/div/div[2]/div/div[2]/a/h3",
            "/html/body/div[6]/main/div/div[4]/div/div[3]/div/div[2]/a/h3",
            "/html/body/div[6]/main/div/div[4]/div/div[4]/div/div[2]/a/h3" };

            for (int i = 0; i < amount; i++)
            {
                BBCHeadlines[i] = await GetInformation(BBCurl, BBCPaths[i]);
                GuardianHeadlines[i] = await GetInformation(Guardianurl, GuardianPaths[i]);
                IndependentHeadlines[i] = await GetInformation(Independenturl, IndependentPaths[i]);
                MailHeadlines[i] = await GetInformation(Mailurl, MailPaths[i]);
                SkyHeadlines[i] = await GetInformation(Skyurl, SkyPaths[i]);
                SunHeadlines[i] = await GetInformation(Sunurl, SunPaths[i]);
        ...
        private static async Task<string> GetInformation(string url, string path)
        {
            ...
            // Select the node based on the given XPath
            var textNode = doc.DocumentNode.SelectSingleNode(path);

            // Check if the node exists, replace #27; with ', and trim the result
            string result = textNode?.InnerText.Replace("#x27;", "'").Trim() ?? "Not found";
